...
from src.modules.stgcn.processor.io import IO
import tools
...
class StGcn(IO):
    ...
    def start(self):
        ...
        # pose estimation
        video, data_numpy, pose_list = self.pose_estimation()
        ...
        if self.arg.render:
            ...
            for image in images:
                ...
                if cv2.waitKey(1) & 0xFF == ord('q'):
                    break
        return pose_list, voting_label_name, data_numpy
    ...
    def set_param(self, openpose, video, shortedge, render=False):
        self.arg.openpose = openpose
        self.arg.video = video
        self.arg.shortedge = shortedge
        self.arg.render = render
    ...
    def pose_estimation(self):
        ...
        if self.arg.openpose is not None:
            ...
            sys.path.append(self.arg.openpose + '/build/python/openpose/Release')
        ...
        while (True):
            ...
            orig_image = cv2.resize(
                orig_image, (self.arg.shortedge, self.arg.shortedge * source_H // source_W))
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('--video',
                            default='../../../test_data/3.mp4',
                            help='Path to video')
        parser.add_argument('--openpose',
                            default='D:\\Desktop\\openpose',
